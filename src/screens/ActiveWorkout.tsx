  ...
  return (
    <Sheet open={open} onClose={onClose} title={session.name} full>
      ...
      {!allDone && (
        <button
          onClick={startGuided}
          className="mb-4 flex w-full items-center justify-center gap-2.5 rounded-xl bg-brand-500 px-6 py-8 text-[15px] font-bold text-white transition active:scale-[0.98] hover:bg-brand-500/90"
        >
